...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        getSceneCoordSystem, bindListener, getObjectName, getObjectUUID,
        initObjectPicking, isObjectAmongObjects, retrieveObjectNames, MediaHTML5,
...
createCSSRule('.botonCSS', ('width: 48px;' + '\n' +
'height: 48px;' + '\n' +
'position: absolute;' + '\n' +
'cursor: pointer;' + '\n' +
'background-image: url("./media/favicon-48x48.png");' + '\n' +
'top: 100px;' + '\n' +
'left: 20px;'), false, '');
addHTMLElement('div', 'item', 'TO', ['CONTAINER'], false);
setHTMLElemAttribute('className', 'botonCSS', 'item', false);
bindHTMLObject('coworking1', 'item', false);
eventHTMLElem('click', 'item', false, function(event) {
    tweenCamera('coworking1', 'coworking2', 2, function() {}, 1);
});

registerOnClick('Cube.024', false, false, [0,1,2], false, function(event) {
    tweenCamera('herreria1', 'herreria2', 1, function() {}, 1);
}, function(event) {});

SWICHT = 'ON';
video1 = loadVideo('./media/VideoMontana.mp4');
registerOnClick('LOGOTV', false, false, [0,1,2], false, function(event) {
    if (SWICHT == 'ON') {
        replaceTexture('Material.002', 'logo artesanias.png.002', video1, false, function() {});
